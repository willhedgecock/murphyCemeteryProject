...
?>
    ...
    <h1><?php echo $row['burial_first_name'] . " " . $row['burial_middle_name'] . " " . $row['burial_last_name'] ?></h1>
        ...
        <?php if ($row['burial_DOB'] == NULL || $row['burial_DOB'] == "0000-00-00") { ?>
            <?php if ($row['burial_birth_year'] != "0") { ?>
        ...
        <?php if ($row['burial_birthplace_city'] != NULL && $row['burial_birthplace_st'] != NULL) { ?>
        ...
        <?php if ($row['burial_date_of_death'] != NULL) { ?>
            <?php if ($row['burial_date_of_death'] != "0000-00-00")  { ?>
            <p>Burial death date: <?php echo $row['burial_date_of_death'] ?></p>
        <?php } } ?>

        <?php if ($row['burial_death_year'] != NULL && $row['burial_death_year'] == NULL) { ?>
