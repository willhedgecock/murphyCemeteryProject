...
<head>
    ...
    <section class="row">
            <div class="column">
                <img src="images/murphyCemetery-18.jpg" alt="Murphy Cemetery sign">
            </div>
            <div class="column">
            <h2>History</h2>
        ...
        <div class="divider"></div>
        <div class="paragraph">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, quisquam hic. Aliquid, culpa? Quo eaque sapiente dolore quam tempora adipisci voluptatum! Delectus ratione minima nostrum perferendis, sed porro id sint officiis pariatur, voluptatibus dicta tenetur vero nobis quo consectetur odio.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, quisquam hic. Aliquid, culpa? Quo eaque sapiente dolore quam tempora adipisci voluptatum! Delectus ratione minima nostrum perferendis, sed porro id sint officiis pariatur, voluptatibus dicta tenetur vero nobis quo consectetur odio.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, quisquam hic. Aliquid, culpa? Quo eaque sapiente dolore quam tempora adipisci voluptatum! Delectus ratione minima nostrum perferendis, sed porro id sint officiis pariatur, voluptatibus dicta tenetur vero nobis quo consectetur odio.</p>
        </div>
        </div>
            <div class="column">
                <img src="images/murphyCemetery-12.jpg" alt="">
            </div>
        </section>
        <section class="row">
